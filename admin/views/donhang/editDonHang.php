              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <?php if (isset($errors['ten_nguoi_nhan'])) { ?>
                    <span class="text-danger"><?= $errors['ten_nguoi_nhan'] ?></span>
                  <?php } ?>
                </div>
                <div class="form-group">
                  <label>Số điện thoại</label>
                  <input type="text" class="form-control" name="sdt_nguoi_nhan" placeholder="Nhập số điện thoại" value="<?= $donHang['sdt_nguoi_nhan'] ?>">
                  <?php if (isset($errors['sdt_nguoi_nhan'])) { ?>
                    <span class="text-danger"><?= $errors['sdt_nguoi_nhan'] ?></span>
                  <?php } ?>
                </div>
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control" name="email_nguoi_nhan" placeholder="Nhập email" value="<?= $donHang['email_nguoi_nhan'] ?>">
                  <?php if (isset($errors['email_nguoi_nhan'])) { ?>
                    <span class="text-danger"><?= $errors['email_nguoi_nhan'] ?></span>
                  <?php } ?>
                </div>
                <div class="form-group">
                  <label>Địa chỉ</label>
                  <input type="text" class="form-control" name="dia_chi_nguoi_nhan" placeholder="Nhập địa chỉ" value="<?= $donHang['dia_chi_nguoi_nhan'] ?>">
                  <?php if (isset($errors['dia_chi_nguoi_nhan'])) { ?>
                    <span class="text-danger"><?= $errors['dia_chi_nguoi_nhan'] ?></span>
                  <?php } ?>
                </div>
                <div class="form-group">
                  <label>Ghi chú</label>
                  <textarea name="ghi_chu" class="form-control" id="" placeholder="Nhập ghi chú"><?= $donHang['ghi_chu'] ?>
                  </textarea>
                </div>
                <hr>
                <div class="form-group">
